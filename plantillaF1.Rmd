...
url <- "https://raw.githubusercontent.com/yodidj/R_2024/refs/heads/main/contribution.csv"
...
# Crear diagramas de caja discriminando por cohorte, género, estado civil y asistencia a eventos
p1 <- ggplot(don1, aes(x = as.factor(Class.Year), y = Tgiving)) + 
  geom_boxplot(outlier.shape = NA) + 
  labs(title = "Donación Total por Cohorte", x = "Cohorte", y = "Donación Total") +
  theme_minimal()

p2 <- ggplot(don1, aes(x = Gender, y = Tgiving)) + 
  geom_boxplot(outlier.shape = NA) + 
  labs(title = "Donación Total por Género", x = "Gender", y = "Donación Total") +
  theme_minimal()

p3 <- ggplot(don1, aes(x = Marital.Status, y = Tgiving)) + 
  geom_boxplot(outlier.shape = NA) + 
  labs(title = "Donación Total por Estado Civil", x = "Estado Civil", y = "Donación Total") +
  theme_minimal()

p4 <- ggplot(don1, aes(x = as.factor(AttendenceEvent), y = Tgiving)) + 
  geom_boxplot(outlier.shape = NA) + 
  labs(title = "Donación Total por Asistencia a Eventos", x = "Asistencia a Eventos", y = "Donación Total") +
  theme_minimal()
